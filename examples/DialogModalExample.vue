...
<template>
  ...
  <DialogModal
    ...
    :class="[
      ...
      'translate-y-full open:starting:translate-y-full open:translate-y-0',
      // wide screen in / out transition
      'md:opacity-0 md:open:starting:opacity-0 md:open:opacity-100',
      'md:open:starting:-translate-x-full md:translate-x-0 md:open:translate-x-0',
      ...
      'open:backdrop:bg-black/40 backdrop:open:starting:bg-black/0 backdrop:bg-black/0',
    ]"
    :open="open"
    @close="close"
    @cancel="close"
